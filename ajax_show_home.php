            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr id="row<?php echo $i;?>">
                        <td><span class="glyphicon glyphicon-download-alt" style="margin-right: 5px;"></span><a href="filemanager_backups/backups.php?file_name=<?php echo str_replace(".zip", "", $backup->backup_dir_files[$i]);?>" target="_blank"><?php echo $backup->backup_dir_files[$i];?></a></td>
