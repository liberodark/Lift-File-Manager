...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) AND strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest')
{
    if ($core->isLogin())
    {
        ...
        {
            $method = $_POST["method"];
            if($method == "admin_create_ticket_for_user")
            {
            ...
            else if($method == "user_create_ticket")
            {
                $subject = $_POST["subject"];
                $message = $_POST["message"];
                $userId = $_POST["user"];
            ...
            else if($method == "change_status_of_ticket")
            {
                ...
                $change = $tickets_class->change_status_of_ticket($ticketId, $new_status, $adminId, $message);
                if($change)
                {
                    echo "true";
                    exit();
