...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) AND strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest')
{
    if ($core->isLogin())
    {
        ...
        {
            $core->adminInfo();
            if ($_POST["showShared"] == $core->admin_id)
            {
...
?>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li <?php if( $user == $core->admin_id ) echo 'class="active"';?>>
                            <a href="javascript:;" onclick="show_what = '<?php echo $core->admin_id;?>'; share_page = 1; share_role = 'admin'; $('#shared_files').click();"><span class="importo"><?php language_filter("my_shared_files")?></span></a>
                        </li>
                        <li <?php if( $user == "all" ) echo 'class="active"';?>>
                            <a href="javascript:;" onclick="show_what = 'all'; share_page = 1; share_role = 'admin'; $('#shared_files').click();"><span class="importo"><?php language_filter("All_Files")?></span></a>
                        </li>
                    </ul>
                </div>
<?php
